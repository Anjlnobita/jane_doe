from jane.doe.events import register
from jane import telethn as tbot
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        await event.reply("Reply to a message to get a permanent telegraph link.")
